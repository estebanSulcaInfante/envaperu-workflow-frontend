...
export const workspaceFeatures = [
  ...
  feature({ key: 'control.productionProgress', areaKey: 'control', sectionKey: 'production-progress', label: 'Avance de OF', description: 'Avance efectivo por objetivo de color.', path: '/control/avance-of', requiredAny: ['OT_VER'], icon: 'progress', defaultPriority: 1, keywords: ['OF', 'objetivo de color', 'avance', 'kg'], task: true }),
