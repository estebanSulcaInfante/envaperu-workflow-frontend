...
export const workspaceFeatures = [
  ...
  feature({ key: 'warehouse.kardex', areaKey: 'warehouse', sectionKey: 'inventory', label: 'Kardex de mi almacén', description: 'Consulta saldos y movimientos dentro del alcance asignado.', path: '/almacen/kardex', aliases: ['/produccion/kardex'], requiredAny: ['INVENTARIO_VER'], icon: 'inventory', defaultPriority: 10, keywords: ['inventario', 'existencias', 'movimientos'], task: true }),
