...
export const workspaceFeatures = [
  ...
  feature({ key: 'warehouse.operations', areaKey: 'warehouse', sectionKey: 'operations', label: 'Operaciones por QR', description: 'Entrada, salida, transferencia, pickup y retorno con contexto explícito.', path: '/almacen/operaciones', requiredAny: ['INVENTARIO_MOVILIZAR'], icon: 'warehouse', defaultPriority: 5, keywords: ['QR', 'pickup', 'custodia'], task: true }),
  feature({ key: 'warehouse.kardex', areaKey: 'warehouse', sectionKey: 'inventory', label: 'Kardex de mi almacén', description: 'Consulta saldos y movimientos dentro del alcance asignado.', path: '/almacen/kardex', matches: ['/almacen/kardex/disponibilidad'], aliases: ['/produccion/kardex'], requiredAny: ['INVENTARIO_VER'], icon: 'inventory', defaultPriority: 10, keywords: ['inventario', 'existencias', 'movimientos'], task: true }),
  feature({ key: 'warehouse.transfers', areaKey: 'warehouse', sectionKey: 'operations', label: 'Transferencias y pickup', description: 'Bandeja de custodia, tránsito, diferencias y retornos.', path: '/almacen/transferencias', requiredAny: ['INVENTARIO_VER'], icon: 'internalSupply', defaultPriority: 15, keywords: ['transferencia', 'pickup', 'tránsito'], task: true }),
  feature({ key: 'warehouse.reservationInbox', areaKey: 'warehouse', sectionKey: 'operations', label: 'Reservas y staging', description: 'Bandeja de picking de mangas reservadas hacia Producción.', path: '/almacen/reservas-staging', aliases: ['/produccion/abastecimiento'], requiredAny: ['ABASTECIMIENTO_VER'], icon: 'reservations', defaultPriority: 12, keywords: ['reserva', 'picking', 'staging', 'mangas'], task: true }),
