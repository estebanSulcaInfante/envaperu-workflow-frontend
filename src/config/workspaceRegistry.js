...
export const workspaceFeatures = [
  ...
  feature({ key: 'masters.wizard', areaKey: 'masters', sectionKey: 'product-engineering', label: 'Configuración guiada', description: 'Asistente Molde, Pieza y PiezaColor.', path: '/datos-maestros/configuracion-guiada', aliases: ['/catalogo/configurar', '/datos-maestros/configurar'], requiredAny: ['ARTICULO_ADMINISTRAR'], icon: 'wizard', defaultPriority: 40, task: true }),
