  ...
  return (
    <Stack spacing={2.5}>
      ...
      <Dialog open={dialog === 'scrap'} onClose={() => setDialog('')} fullWidth maxWidth="md"><DialogTitle>Pesar bolsa de merma recuperable</DialogTitle><DialogContent><Box sx={{ pt: 1, display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(2, 1fr)' }, gap: 2 }}>
        ...
        <TextField label="Documento/origen *" value={scrapForm.origen_id} onChange={(event) => setScrapForm({ ...scrapForm, origen_id: event.target.value })} helperText="Ejemplo: OF-000123, OE-000045 o contingencia aprobada." />
