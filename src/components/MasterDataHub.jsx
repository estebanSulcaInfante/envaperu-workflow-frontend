...
const catalogEntries = [
  ...
  { id: 'configurar', area: 'PRODUCTO', name: 'Configuración guiada de producto', object: 'Asistente Molde ↔ Pieza y generación de PiezaColor', path: '/datos-maestros/configuracion-guiada', maturity: 'DISPONIBLE' },
  { id: 'clasificacion', area: 'PRODUCTO', name: 'Líneas y familias', object: 'Clasificadores de producto y combinaciones N:M habilitadas', path: '/datos-maestros/clasificacion', maturity: 'DISPONIBLE' },
  { id: 'colores', area: 'PRODUCTO', name: 'Colores y recetas', object: 'FamiliaColor, ColorProducción, HEX visual y receta versionada', path: '/datos-maestros/colores', maturity: 'DISPONIBLE' },
  { id: 'materiales', area: 'ABASTECIMIENTO', name: 'Materias primas', object: 'Resinas, colorantes, aditivos y recuperado', path: '/datos-maestros/materiales?catalogo=materials', maturity: 'DISPONIBLE' },
  { id: 'proveedores', area: 'ABASTECIMIENTO', name: 'Proveedores', object: 'Identidad y reglas de abastecimiento', path: '/datos-maestros/materiales?catalogo=providers', maturity: 'DISPONIBLE' },
  { id: 'categorias', area: 'ABASTECIMIENTO', name: 'Categorías de recepción', object: 'Modalidad, unidad y requisitos por material', path: '/datos-maestros/materiales?catalogo=categoryRules', maturity: 'DISPONIBLE' },
